...
function enableOrientation() {
	if (iPhone) {
		window.addEventListener("devicemotion", captureOrientationPhone, false);
	} else {
...
function captureOrientationPhone(e) {
	
	// = e.accelerationIncludingGravity.x
	betaVal = -e.accelerationIncludingGravity.y;
	gammaVal = e.accelerationIncludingGravity.x;
...
function disableOrientation() {
	...
	window.removeEventListener("devicemotion", captureOrientationPhone, false)
}
